...
export default function Home() {
  ...
  const handleCommand = async () => {
    ...
    try {
      ...
      // Step 2: Parse with Eliza-powered Claude
      console.log('🤖 Eliza parsing command...');
      ...
      console.log('✅ Eliza parsed:', parsed);

      // Step 3: Show Eliza's friendly response
      if (parsed.response) {
      ...
      if (parsed.action === 'send') {
        if (!parsed.recipient) {
          alert(parsed.response || 'Please provide a phone number or wallet address!');
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm opacity-60 mb-8">🤖 Powered by Eliza OS</p>
          <button
            onClick={login}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-white p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs opacity-60">🤖 Powered by Eliza AI</div>
            </div>
          </div>
        ...
        {/* Wallet Address */}
        {walletAddress && (
          <div className="bg-white bg-opacity-15 backdrop-blur-lg rounded-xl p-4 mb-6 border border-white border-opacity-20">
        ...
        {/* Command Center */}
        <div className="bg-white bg-opacity-15 backdrop-blur-lg rounded-2xl p-6 mb-6 border border-white border-opacity-20">
          <div className="flex items-center gap-2 mb-4">
            <Globe className="w-5 h-5 text-purple-400" />
            <h2 className="font-semibold">Talk to Lingo AI 🤖</h2>
          </div>
          ...
          <div className="mb-4">
            ...
            <select 
              ...
              className="bg-white bg-opacity-20 border border-white border-opacity-30 rounded-lg px-4 py-2 text-sm w-full text-white focus:outline-none focus:ring-2 focus:ring-purple-400"
            >
              {languages.map(lang => (
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder={
                language === 'en' ? 'Ask me anything or say "Send 50 USDC to +1-555-1234"' :
              ...
              className="flex-1 bg-white bg-opacity-20 border border-white border-opacity-30 rounded-lg px-4 py-3 text-white placeholder-white placeholder-opacity-60 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:bg-opacity-30"
            />
            <button
          ...
          <div className="mt-3 text-xs opacity-60">
            💬 Try: "Send crypto to +1-555-1234" • "What's my balance?" • "How does this work?"
          </div>
        </div>
        ...
        {transactions.length === 0 && (
          <div className="bg-white bg-opacity-10 rounded-2xl p-8 text-center border-2 border-dashed border-purple-400 border-opacity-30">
            ...
            <div className="text-sm opacity-60">
              Try asking me to send crypto, check your balance, or ask any questions!
            </div>
          </div>
        )}
      </div>
